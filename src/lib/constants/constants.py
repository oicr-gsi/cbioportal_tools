...
meta_info_map = {'CLINICAL:PATIENT_ATTRIBUTES':      ['CLINICAL', 'PATIENT_ATTRIBUTES'],
                 ...
                 'MUTATION_EXTENDED:MAF_TGL':                     ['MUTATION_EXTENDED', 'MAF_TGL', 'mutations', 'true'],
...
config2name_map = {'CLINICAL:SAMPLE_ATTRIBUTES':        'clinical_samples',
		   ...
		   'MUTATION_EXTENDED:MAF_TGL':            'mutations_extended',
...
supported_pipe = {'MUTATION_EXTENDED':            ['MAF', 'MAF_TGL','Strelka', 'Mutect', 'Mutect2',
                                                    'MutectStrelka', 'GATKHaplotypeCaller'],
